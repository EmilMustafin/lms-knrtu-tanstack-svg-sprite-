...
const inputDir = path.join(cwd, 'src', 'shared', 'assets', 'icons', 'main');
const inputDirRelative = path.relative(cwd, inputDir);
const outputDir = path.join(cwd, 'src', 'shared', 'assets', 'icons', 'model');
...
async function generateIconFiles() {
  ...
  const typeOutputFilepath = path.join(cwd, 'src', 'shared', 'ui', 'icon', 'types.ts');
